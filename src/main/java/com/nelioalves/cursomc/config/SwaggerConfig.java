...
public class SwaggerConfig {
	...
	private final ResponseMessage m201 = customMessageCreate();
	...
	private ApiInfo apiInfo() {
		...
		"Está API foi criada com base no Curso de Spring Boot do professor Nelio Alves pela Udemy",
		"Versão 1.0",
		"https://www.udemy.com/terms",
		new Contact("João Vitor", "", "joao.vfg16@gmail.com"),
	...
	private ResponseMessage customMessageCreate() {
