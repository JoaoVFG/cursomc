...
public class DBServiceTest {
	...
	public void instantiateTesteDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Paulo", "paulo@unimedcpv.com.br", "36378912377", TipoCliente.PESSOAFISICA, cryptPasswordEncoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "nelio.iftm@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, cryptPasswordEncoder.encode("123"));
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, simpleDateFormat.parse("30/10/2017 00:00"), null);
